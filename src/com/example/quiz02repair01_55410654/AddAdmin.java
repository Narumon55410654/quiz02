...
public class AddAdmin extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		add = (Button) findViewById(R.id.btnadd_654);
		show = (Button) findViewById(R.id.btnshow_654);
		play = (Button) findViewById(R.id.btnplay_654);
		close = (Button) findViewById(R.id.btnclose_admin_654);
	...
	private boolean add() {
		...
		e2 = (EditText) findViewById(R.id.e2admin_654);
		e3 = (EditText) findViewById(R.id.e3_654);
		e4 = (EditText) findViewById(R.id.e4_654);
